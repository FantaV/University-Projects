...
// Funzione che calcola e stampa il grado di associazione in base a cramer_V
void gradoAss(double cramer_V) {
    string associazione;
...
int main() {
    ...
    // Passaggio del valore cramer_V alla funzione gradoAss
    gradoAss(cramer_V);
